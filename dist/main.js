...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*::after, *::before, *{\n    box-sizing: border-box;\n}\n\nhtml{\n    height: 100%;\n}\n\nbody{\n    min-height: 100%;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n}\n\n.header-bar{\n    height: 75px;\n    display: flex;\n    justify-content: left;\n    border-bottom: 1px solid black; /*temp*/\n}\n\n.header-title{\n    font-size: 2rem;\n    margin-left: 5px;\n}\n\n#content{\n    flex-grow: 1; \n    display: grid;\n    grid-template-rows: 1fr 100px;\n    grid-template-columns: minmax(150px, 300px) 1fr;\n}\n\n.sidebar{\n    padding-left: 20px;\n}\n\n.top-sidebar{\n\n}\n\n.bottom-sidebar{\n\n}\n\n.projects-container > div{\n    background-color: white;\n}\n\n.bottom-sidebar-header{\n    border-bottom: 1px solid black;\n    margin-bottom: 10px;\n}\n\n.bottom-sidebar-title{\n    margin: 0;\n}\n\n.project-listing{\n    display: flex;\n    justify-content: space-between;\n}\n\n.add-project-interface{\n    display: none;\n}\n\n.add-project-button{\n\n}\n\n.project-name-input{\n\n}\n\n.sidebar > ul{\n    list-style: none;\n    padding: 0;\n}\n\n.sidebar > ul > li{\n    margin-bottom: 5px;\n    padding: 3px;\n    background-color: white;\n}\n\n.sidebar > ul > li:hover,\n.projects-container > .project-listing:hover{\n    filter: brightness(85%);\n    cursor: pointer;\n}\n\n.tasks-display{\n    padding-left: 30px;\n    padding-right: 30px;\n    flex-grow: 0;\n    height: fit-content;\n}\n\n.tasks > p:first-of-type{\n    font-size: 2rem;\n    margin: 0;\n}\n\n.task-container{\n    border-bottom: 1px solid black;\n}\n\n.task-info{\n\n}\n\n.task-title{\n\n}\n\n.task-description{\n\n}\n\n.task-date{\n\n}\n\n.task-priority{\n\n}\n\n.add-task-interface{\n}\n\n.add-task-form{\n    display: none; \n}\n\ninput{\n    display: block;\n}\n\n.task-buttons{\n\n}\n\n.add-task-button{\n\n}\n\n.remove-task-button{\n    \n}\n\n.edit-task-button{\n\n}\n\n.edit-task-container{\n    display: none;\n}\n\n.edit-task-buttons{\n\n}\n\n.save-edit-button{\n\n}\n\n.cancel-edit-button{\n\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;AAC1B;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,gBAAgB;IAChB,SAAS;IACT,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,qBAAqB;IACrB,8BAA8B,EAAE,OAAO;AAC3C;;AAEA;IACI,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,6BAA6B;IAC7B,+CAA+C;AACnD;;AAEA;IACI,kBAAkB;AACtB;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,SAAS;AACb;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,aAAa;AACjB;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;IACI,gBAAgB;IAChB,UAAU;AACd;;AAEA;IACI,kBAAkB;IAClB,YAAY;IACZ,uBAAuB;AAC3B;;AAEA;;IAEI,uBAAuB;IACvB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;IACnB,YAAY;IACZ,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,SAAS;AACb;;AAEA;IACI,8BAA8B;AAClC;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;AACA;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,cAAc;AAClB;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;IACI,aAAa;AACjB;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA;;AAEA","sourcesContent":["*::after, *::before, *{\n    box-sizing: border-box;\n}\n\nhtml{\n    height: 100%;\n}\n\nbody{\n    min-height: 100%;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n}\n\n.header-bar{\n    height: 75px;\n    display: flex;\n    justify-content: left;\n    border-bottom: 1px solid black; /*temp*/\n}\n\n.header-title{\n    font-size: 2rem;\n    margin-left: 5px;\n}\n\n#content{\n    flex-grow: 1; \n    display: grid;\n    grid-template-rows: 1fr 100px;\n    grid-template-columns: minmax(150px, 300px) 1fr;\n}\n\n.sidebar{\n    padding-left: 20px;\n}\n\n.top-sidebar{\n\n}\n\n.bottom-sidebar{\n\n}\n\n.projects-container > div{\n    background-color: white;\n}\n\n.bottom-sidebar-header{\n    border-bottom: 1px solid black;\n    margin-bottom: 10px;\n}\n\n.bottom-sidebar-title{\n    margin: 0;\n}\n\n.project-listing{\n    display: flex;\n    justify-content: space-between;\n}\n\n.add-project-interface{\n    display: none;\n}\n\n.add-project-button{\n\n}\n\n.project-name-input{\n\n}\n\n.sidebar > ul{\n    list-style: none;\n    padding: 0;\n}\n\n.sidebar > ul > li{\n    margin-bottom: 5px;\n    padding: 3px;\n    background-color: white;\n}\n\n.sidebar > ul > li:hover,\n.projects-container > .project-listing:hover{\n    filter: brightness(85%);\n    cursor: pointer;\n}\n\n.tasks-display{\n    padding-left: 30px;\n    padding-right: 30px;\n    flex-grow: 0;\n    height: fit-content;\n}\n\n.tasks > p:first-of-type{\n    font-size: 2rem;\n    margin: 0;\n}\n\n.task-container{\n    border-bottom: 1px solid black;\n}\n\n.task-info{\n\n}\n\n.task-title{\n\n}\n\n.task-description{\n\n}\n\n.task-date{\n\n}\n\n.task-priority{\n\n}\n\n.add-task-interface{\n}\n\n.add-task-form{\n    display: none; \n}\n\ninput{\n    display: block;\n}\n\n.task-buttons{\n\n}\n\n.add-task-button{\n\n}\n\n.remove-task-button{\n    \n}\n\n.edit-task-button{\n\n}\n\n.edit-task-container{\n    display: none;\n}\n\n.edit-task-buttons{\n\n}\n\n.save-edit-button{\n\n}\n\n.cancel-edit-button{\n\n}\n"],"sourceRoot":""}]);
// Exports
...
function addSidebarListeners(){
    ...
    inbox.onclick = () => {
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.Inbox);
...
function addTaskSubmitListener(){
    ...
    submitButton.onclick = () => {
        ...
        let newTask = (0,_task__WEBPACK_IMPORTED_MODULE_1__["default"])(taskName.value, 
        ...
        _project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.add(newTask);

        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject]);
...
function addTaskRemoveListener(){
    ...
    removeButtons.forEach((button) => {
        button.onclick = () => {
            ...
            _project__WEBPACK_IMPORTED_MODULE_0__.projects[projectIndex].tasks.delete(taskID);
            
            (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.projects[projectIndex]);
...
function addSaveEditTaskListener(){
    ...
    saveEditButtons.forEach((button) => {
        button.onclick = () => {
            ...
            console.log(_project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.list[taskId]);

            _project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.list[taskId].title = newName;
            _project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.list[taskId].description = newDescription;
            _project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.list[taskId].dueDate = newDate;
            _project__WEBPACK_IMPORTED_MODULE_0__.projects[currentProject].tasks.list[taskId].priority = newPriority;
...
function addProjectSubmitListener(){
    ...
    submitButton.onclick = () => {
        ...
        if(projectName.value){
            let newProject = new _project__WEBPACK_IMPORTED_MODULE_0__["default"](projectName.value);
            projectName.value = '';
            (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(newProject);
            (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleProjectForm)('hide');
...
function addRemoveProjectListeners(){
   ...
   for (let i = 0; i < removeButtons.length; i++) {
        ...
        button.onclick = (e) => {
            ...
            e.stopPropagation();
            _project__WEBPACK_IMPORTED_MODULE_0__.projects.splice(projectIndex, 1);
            (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.createProjectList)('reset');
            (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.Inbox);
        }
...
function addUpcomingListeners(){
    ...
    todayListing.onclick = () => {
        _project__WEBPACK_IMPORTED_MODULE_0__.Today.tasks.resetList();
        ...
        _project__WEBPACK_IMPORTED_MODULE_0__.projects.forEach((project) => {
            ...
            project.tasks.list.forEach((task) => {
               if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate))){
                    ...
                    _project__WEBPACK_IMPORTED_MODULE_0__.Today.tasks.add(taskCopy);
               }
            })
        });

        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.Today);
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleTaskForm)('hide');
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleProjectForm)('hide');
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleAddTaskButton)();
    }

    const upcomingListing = document.querySelector('.top-sidebar > li:nth-child(3)');

    upcomingListing.onclick = () => {
        _project__WEBPACK_IMPORTED_MODULE_0__.Upcoming.tasks.resetList();
        ...
        _project__WEBPACK_IMPORTED_MODULE_0__.projects.forEach((project) => {
            ...
            project.tasks.list.forEach((task) => {
               if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.dueDate))){
                    let taskCopy = task;
                    taskCopy.projectName = task.project;
                    _project__WEBPACK_IMPORTED_MODULE_0__.Upcoming.tasks.add(taskCopy);
               }
            })
        });

        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.displayTasks)(_project__WEBPACK_IMPORTED_MODULE_0__.Upcoming);
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleTaskForm)('hide');
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleProjectForm)('hide');
        (0,_renderUI__WEBPACK_IMPORTED_MODULE_2__.toggleAddTaskButton)();
    }
...
function getProjectIndex(projectName){
    ...
    let projectIndex = _project__WEBPACK_IMPORTED_MODULE_0__.projects.findIndex((project) => {
        if(projectName){
...
function Project(name){
    ...
    this.name = name;
    this.tasks = new _list__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
function renderUI(){
    ...
    displayTasks(_project__WEBPACK_IMPORTED_MODULE_1__.Inbox);
...
function displayTasks(project){
    ...
    project.tasks.list.forEach((task, index) => {
        ...
        if(task.dueDate){
            ...
            taskDueDate.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, 'MM/dd/yyyy');
...
function createProjectList(option){
    ...
    _project__WEBPACK_IMPORTED_MODULE_1__.projects.forEach((project) => {
...
function createEditTaskInterface(task){
    ...
    newDate.type = 'date';
    if(task.dueDate) {newDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, 'yyyy-MM-dd')};
...
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list */ "./src/js/list.js");
/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project */ "./src/js/project.js");
/* harmony import */ var _renderUI__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderUI */ "./src/js/renderUI.js");
...
/**
 * Commit
 * Work on creating local storage for user
